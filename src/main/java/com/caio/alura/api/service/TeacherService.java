...
public class TeacherService {
    ...
    public void saveTeacher(Teacher teacher) {
        ...
        logger.info(".saveTeacher: Teacher {} saved successfully", teacher.getName());
    }
    ...
    public Page<TeacherRegisterReturnBody> getAllActiveTeachers(Pageable pageable) {
        ...
        logger.info(".getAllActiveTeachers: Received {} active teachers", result.getTotalElements());
        return result;
    }
    ...
    public boolean exists(Long id) {
        logger.info(".exists: Checking if teacher with id {} exists", id);
    ...
    public Teacher getRandomTeacherAvailable(LocalDateTime dateTime, Department department) {
        logger.info(".getRandomTeacherAvailable: Getting random available teacher for datetime {} and department {}", dateTime, department);
        return this.teacherRepository.getRandomTeacherAvailable(dateTime, department);
    }

    public Boolean isActive(Long id) {
        logger.info(".isActive: Checking if teacher with id {} is active", id);
